...
# 추가된 뉴스 소스 리스트 (총 30개 이상)
SOURCES = [
    {"name": "CNA", "url": "https://www.channelnewsasia.com/api/v1/rss-outbound-feed?_format=xml", "type": "rss"},
    ...
    {"name": "The Star", "url": "https://www.thestar.com.my/rss/aseanplus", "type": "rss"},
    {"name": "Bernama", "url": "http://mrembm.bernama.com/rss.php", "type": "rss"},
    # 구글 검색 기반 추가 소스 (image_10ae82.jpg 기반)
    ...
    {"name": "Singapore Business Review", "query": "site:sbr.com.sg", "type": "search"},
    ...
    {"name": "Anime Festival Asia", "query": "site:animefestival.asia", "type": "search"},
...
def send_to_jira(article, ai_data):
    ...
    # 두 번째 사진(image_10b5ad.jpg) 스타일의 레이블 적용: News + 카테고리
...
def main():
    ...
    print(f"{len(articles)}개 뉴스 분석 중...")
    combined = []
    for art in articles:
